...
const profileConfig = {
  ...
  title: {
    zh: "AI出海创业者 · 超级个体 OPC",
    en: "AI Global Builder · OPC Super Individual",
  },
  description: {
    zh: "能独立完成前后端、算法、硬件、产品设计与营销增长，把想法快速做成可验证、可传播、可商业化的 AI 出海产品。",
    en: "I independently cover frontend, backend, algorithms, hardware, product design, and marketing to turn ideas into AI products that can validate, spread, and monetize fast.",
  },
  summary: {
